...
<div class="entry-content col-sm-12 col-md-9" itemscope itemtype="http://schema.org/Person">
    ...
    ?>
        <div class="agent-data">
            ...
            <?php endif; ?>
            <?php if ( isset( $fields['designations'] ) ) : ?>
            ...
            <div class="contact-info">
                ...
                <?php // pull office info
                if ( isset( $fields['office_id'] ) ) :
                ...
                <?php endif; ?>
                <?php if ( isset( $fields['mobile_phone'] ) ) : ?>
        ...
        <div role="tabpanel" class="agent-tabs">
            ...
            <?php endif; ?>
            <?php if ( $team = AgentRoster::get_team( $post->ID ) ) : ?>
                <li class="tab_team">
                    <a href="#team" aria-controls="team" role="tab" data-toggle="tab">Team</a>
                </li>
            <?php endif; ?>
            <?php if ( isset( $fields['custom_tab_name'] ) ) : ?>
                <li class="tab_custom">

...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <?php if ( is_active_sidebar( 'buyers-page-sidebar' ) && is_active_sidebar( 'buying-page-sidebar' ) ) : ?>
    ...
    <?php if ( is_active_sidebar( 'buyers-page-sidebar' ) && is_active_sidebar( 'buyers-page-sidebar') ) : ?>
